export const PAGES_EN = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Add dishes, change prices and availability from one panel — no technical skills needed.",
    ...
    plans: [
      {
        ...
        features: ["1 venue", "1 menu", "50 dishes", "QR codes", "Multiple languages", "No card"],
        cta: "Sign up",
      },
      {
        name: "Basic",
        ...
        features: ["1 venue", "3 menus", "Unlimited dishes", "QR codes", "Call waiter", "Multiple languages"],
        cta: "Start Basic",
        badge: "Popular",
        highlighted: true,
      },
  ...
  home: {
    ...
    trialCardBody: "Create a venue, add dishes and test QR with your team before choosing a plan.",
