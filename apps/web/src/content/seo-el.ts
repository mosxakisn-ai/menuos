...
export const SEO_PRICING_FAQ = [
  ...
  },
  {
    ...
    a: "Το Live 360° (κλήση σερβιτόρου με μπιπ, φωνή για μηνύματα κουζίνας, οθόνες κουζίνας/bar) είναι στο πλάνο Pro — όχι στη δοκιμή ούτε στο Basic.",
  },
  {
    q: "Ακούγεται φωνή στο κινητό του σερβιτόρου;",
    a: "Ναι, στο Pro — όταν η κουζίνα στέλνει μήνυμα (όχι στις κλήσεις πελάτη). Μπιπ και φωνή με τραπέζι και χώρο, στα ελληνικά. Ενεργοποίηση/απενεργοποίηση από τις ρυθμίσεις.",
  },
  {
