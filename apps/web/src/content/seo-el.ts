...
export const SEO_PAGES = {
  ...
  contact: {
    ...
    description:
      "Επικοινωνήστε με την ομάδα MenuOS για δοκιμή, τιμολόγηση Enterprise ή υποστήριξη. Email: info@b-os.gr",
    path: "/epikoinonia",
...
export const SEO_QR_MENU_FAQ = [
  ...
  {
    q: "Πόσες γλώσσες υποστηρίζονται;",
    a: "Ελληνικά, Αγγλικά, Γερμανικά και Γαλλικά από την πρώτη μέρα.",
  },
  {
