  ...
  pages: {
    ...
    settings: {
      ...
      postsTab: {
        ...
        linkedWaiterNote:
          "Σερβιτόρος δάπεδου = πόστο με τύπο «Σερβιτόρος» εδώ (π.χ. Services Σάλα). Μετά το αντιστοιχείς στο tab Προσωπικό.",
        ...
        junkRemovedHint:
          "Αφαιρέθηκε πόστο με λάθος τύπο — για σερβιτόρους διάλεξε τύπο «Σερβιτόρος».",
