  ...
  pages: {
    ...
    settings: {
      ...
      linksTab: {
        title: "Links οθονών",
        description:
          "Άνοιξε κάθε link σε tablet στο αντίστοιχο πόστο — χωρίς login. Εμφανίζονται μόνο τα ενεργά πόστα.",
        hint: "Αντιγράψε ή άνοιξε το link στο tablet.\nΓια 2ο tablet στο ίδιο πόστο (π.χ. Παραλία): πρόσθεσε νέα οθόνη με όνομα.",
        loading: "Φόρτωση πόστων…",
        empty: "Δεν έχεις ενεργά πόστα. Πήγαινε στο tab «Πόστα» και ενεργοποίησε τουλάχιστον ένα.",
      },
      messagesTab: {
        title: "Μηνύματα",
      ...
      personnel: {
        title: "Προσωπικό",
        description:
          "Κάθε μέλος έχει δικό του link σερβιτόρου — μοιράστε το στο κινητό/tablet του. Τα πόστα φιλτράρουν ποιες ειδοποιήσεις πάσου βλέπει.",
        addTitle: "Νέο μέλος",
        addStaff: "Προσθήκη",
        listTitle: "Ομάδα",
        ...
        cancelEdit: "Άκυρο",
        stationsHint:
          "Ποιες ειδοποιήσεις βλέπει στο κινητό/tablet — Services = κλήσεις πελάτη + όλα τα πάσο.",
