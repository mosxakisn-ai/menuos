...
export const DASHBOARD_EL = {
  ...
  pages: {
    ...
    qr: {
      ...
      bulkDesc:
        "Όσα τραπέζια, δωμάτια ή ξαπλώστρες χρειάζεσαι — χωρίς όριο πλάνου. Έως 200 θέσεις κάθε φορά (για περισσότερες, επανάλαβε με νέο εύρος). Προαιρετικό πρόθεμα για ζώνες (π.χ. sala-, kipos-).",
      ...
      spotPlaceholderTable: "12 ή sala-1",
      addSpot: "Προσθήκη",
      ...
      labelHint: "Μόνο γράμματα, αριθμοί, παύλα και κάτω παύλα (π.χ. 12, sala-1).",
      previewSpot: "Preview",
      spotTypes: {
        TABLE: "Τραπέζι",
        ROOM: "Δωμάτιο",
    ...
    waiter: {
      ...
      description:
        "Οι πελάτες καλούν από το QR menu. Ενημερώνεται αυτόματα. Στείλε το link στο κινητό του σερβιτόρου — χωρίς login — και ενεργοποίησε ειδοποιήσεις εκεί.",
    },
    billing: {
      title: "Συνδρομή",
    ...
    settings: {
      ...
      personnel: {
        title: "Προσωπικό",
        description: "Ονόματα και ρόλοι του staff. Σύντομα θα συνδέονται με login και links ανά τμήμα.",
        addStaff: "Προσθήκη (σύντομα)",
        colName: "Όνομα",
        colRole: "Ρόλος",
        colStations: "Τμήματα",
      },
