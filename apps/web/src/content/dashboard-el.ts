...
export const DASHBOARD_EL = {
  ...
  billing: {
    ...
    renewal: {
      ...
      autoOn:
        "Η συνδρομή σου ανανεώνεται αυτόματα κάθε μήνα με την κάρτα που έδωσες. Αν προτιμάς να πληρώνεις μόνος σου, μπορείς να το σταματήσεις — χωρίς να χάσεις την τρέχουσα περίοδο.",
      autoOff: (date: string) =>
        `Η αυτόματη ανανέωση είναι απενεργοποιημένη. Η τρέχουσα περίοδος λήγει ${date} — δεν θα χρεωθείς ξανά χωρίς να το ζητήσεις εσύ.`,
      manualRenewHint:
        "Μετά τη λήξη μπορείς να ξαναπληρώσεις από αυτή τη σελίδα. Ο κατάλογός σου μένει αποθηκευμένος.",
      stopButton: "Διακοπή αυτόματης ανανέωσης",
      resumeButton: "Επαναενεργοποίηση αυτόματης ανανέωσης",
      stopConfirm:
        "Η συνδρομή θα συνεχίσει κανονικά μέχρι το τέλος της περιόδου. Μετά δεν θα γίνει αυτόματη χρέωση — μπορείς να ξαναπληρώσεις μόνος σου από εδώ.",
      saved: "Η ρύθμιση ενημερώθηκε.",
      loading: "Αποθήκευση…",
      networkError: "Σφάλμα δικτύου",
    },
  },
  ...
  pages: {
    ...
    history: {
      title: "Ιστορικό",
      description:
        "Παραδόσεις πάσου που ολοκληρώθηκαν — χρόνος από «έτοιμο» μέχρι «παρέδωσα», ανά χώρο, πόστο και προσωπικό.",
      daysLabel: "Περίοδος",
      days7: "7 ημέρες",
      days30: "30 ημέρες",
      days90: "90 ημέρες",
      filterDay: "Ημέρα",
      filterDayHint: "Άδειο = όλες οι ημέρες της περιόδου · με ημερομηνία = μόνο εκείνη την ημέρα.",
      filterDayClear: "Όλες",
      filterSpot: "Χώρος",
      filterPost: "Πόστο",
      filterStaff: "Προσωπικό",
      filterAll: "Όλα",
      limitLabel: "Εγγραφές",
      limit50: "50",
      limit100: "100",
      limitAll: "Όλες",
      showingCount: (count: number, limit: 50 | 100 | "all") =>
        limit === "all" ? `${count} εγγραφές` : `Εμφάνιση ${count} (μέχρι ${limit})`,
      truncatedHint: "Υπάρχουν κι άλλες — στενότερο φίλτρο ή μικρότερη περίοδο",
      loading: "Φόρτωση...",
    ...
    settings: {
      ...
      personnel: {
        title: "Προσωπικό",
        description:
          "Φτιάξε εργαζόμενο: όνομα, πόστο και χώρο. Διάλεξε πόστο — το κινητό ή tablet υπολογίζεται αυτόματα.",
        ...
        cancelEdit: "Άκυρο",
        formHint:
          "Διάλεξε πόστο με όνομα — κινητό για σερβιτόρο, tablet για κουζίνα/μπαρ. Το πόστο πρέπει να ταιριάζει με Ρυθμίσεις → Μηνύματα.",
        messagesScopeWaiter:
        ...
        fieldsRequiredHint:
          "Όνομα, πόστο και χώρος (σερβιτόρος) είναι υποχρεωτικά. Όλα τα πόστα εμφανίζονται με το όνομά τους.",
        colLink: "Link & QR",
        colLinkHint:
      ...
      services: {
        ...
        historyColSpot: "Χώρος",
        historyColPost: "Πόστο",
  ...
  subscriptionStatus: {
    ...
    endsOnNoRenewal: (date: string) => `Λήγει ${date} — χωρίς αυτόματη ανανέωση`,
