  ...
  pages: {
    ...
    settings: {
      ...
      messagesTab: {
        title: "Μηνύματα",
        description:
          "Ορίζεις εδώ τα μηνύματα ανά πόστο — χρώμα, κείμενο, προσθήκη ή διαγραφή. Στο Προσωπικό διαλέγεις ποιο σετ βλέπει κάθε άτομο.",
        hint:
          "Services = χάρτης θέσεων σερβιτόρου.\nΚάθε πόστο = γρήγορα κουμπιά tablet.\nΈνα χρώμα ανά πόστο — όλα τα μηνύματα του ίδιου πόστου το ίδιο χρώμα.",
        byPostTitle: "Μηνύματα ανά πόστο",
        byPostHint:
          "Επεξεργάσου κείμενα, πρόσθεσε ή σβήσε μηνύματα. Νέο πόστο εμφανίζεται πρώτο. Διαγραφή ολόκληρου πόστου: «Αφαίρεση πόστου» στην κάρτα του (όχι στο Services).",
