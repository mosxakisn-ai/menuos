...
export const DASHBOARD_EL = {
  ...
  upgrade: {
    ...
    live360:
      "Οι οθόνες σερβιτόρου, το ιστορικό παραδόσεων και οι κλήσεις από QR (Live 360°) είναι διαθέσιμα μόνο στο πλάνο Pro — όχι στη δοκιμή ούτε στο Basic.",
    live360Cta: "Δες το πλάνο Pro",
  },
  proFeature: {
    live360: {
