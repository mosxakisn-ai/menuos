...
export const DASHBOARD_EL = {
  ...
  onboarding: {
    ...
    guideIntro: "Ολοκλήρωσε 3 βήματα — μετά ανοίγουν όλες οι σελίδες του panel.",
    navLockedHint: "Ολοκλήρωσε πρώτα τα 3 βήματα εκκίνησης (Επισκόπηση)",
    lockBanner: (step: number, label: string) =>
      `Βήμα ${step}/3: ${label} — οι υπόλοιπες σελίδες κλειδώνονται μέχρι να τελειώσεις.`,
    ...
    stepLabels: ["Άνοιξε κατάστημα", "Φτιάξε κατάλογο", "Βγάλε QR"] as string[],
