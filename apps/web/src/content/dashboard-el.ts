...
export const DASHBOARD_EL = {
  ...
  waiter: {
    ...
    shareDescription:
      "Αντέγραψε και στείλε το link (π.χ. με WhatsApp). Στο κινητό: άνοιξε τη σελίδα, συνδέσου και πάτα «Ενεργοποίηση» για ειδοποιήσεις.",
    sharePerDevice: "Οι ειδοποιήσεις είναι ανά συσκευή — αν τις ενεργοποιήσεις εδώ στο PC, το κινητό δεν ειδοποιείται.",
