  ...
  pages: {
    ...
    settings: {
      ...
      tablesTab: {
        ...
        description:
          "Σχεδίασε τραπέζια, χαπλώστρες και δωμάτια — ανά ζώνη (κήπος, παραλία, αίθουσα κ.λπ.).",
      },
      ...
      operations: {
        ...
        departmentsHint:
          "Ενεργοποίηση με checkbox και δικό σου όνομα (π.χ. «Grill» αντί «Κουζίνα»). Εμφανίζεται στον σερβιτόρο, push και οθόνες.",
