  ...
  pages: {
    ...
    settings: {
      ...
      postsTab: {
        ...
        hint: "Μέχρι 12 πόστα. Πάτα «Νέο πόστο» και γράψε τον ρόλο (π.χ. Μάγειρας, Σερβιτόρος).",
        postNamePlaceholder: "π.χ. Μάγειρας, Σερβιτόρος",
      },
      linksTab: {
      ...
      messagesTab: {
        title: "Μηνύματα",
        description:
          "Ρύθμισε μηνύματα ανά πόστο — ο σερβιτόρος βλέπει τα δικά του, η κουζίνα/μπαρ τα δικά τους.",
        hint:
          "Services = τι εμφανίζεται στον χάρτη θέσεων του σερβιτόρου.\nΚάθε πόστο (Μάγειρας, Μπαρ…) = γρήγορα κουμπιά στην οθόνη tablet.\nΣτο Προσωπικό, το πόστο καθορίζει ποια μηνύματα βλέπει κάθε άτομο.",
        byPostTitle: "Μηνύματα ανά πόστο",
        byPostHint:
          "Κάθε εργαζόμενος βλέπει μόνο τα μηνύματα του πόστου που του έχεις βάλει στο tab Προσωπικό.",
      ...
      personnel: {
        title: "Προσωπικό",
        description:
          "Φτιάξε εργαζόμενο: όνομα, ρόλος, χώρος και πόστο. Το πόστο καθορίζει και ποια μηνύματα βλέπει — κάθε άτομο παίρνει δικό του link.",
