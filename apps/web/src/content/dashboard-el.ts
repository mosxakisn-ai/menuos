...
export const DASHBOARD_EL = {
  ...
  pages: {
    ...
    settings: {
      ...
      messagesTab: {
        title: "Μηνύματα",
        description: "Γρήγορα κουμπιά στις οθόνες tablet και τι βλέπει ο σερβιτόρος στον χάρτη θέσεων.",
      },
      venueTab: {
        title: "Κατάστημα",
      ...
      personnel: {
        title: "Προσωπικό",
        description:
          "Φτιάξε εργαζόμενο: όνομα, ρόλος, χώρος και πόστο. Κάθε άτομο παίρνει δικό του link — ανοίγει panel σερβιτόρου μόνο για τον χώρο του.",
