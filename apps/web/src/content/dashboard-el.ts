...
export const DASHBOARD_EL = {
  ...
  push: {
    ...
    managerHint: "Λαμβάνεις push για κλήσεις και πάσο ολόκληρου του καταστήματος σε αυτή τη συσκευή.",
  },
  photos: {
  ...
  pages: {
    ...
    settings: {
      ...
      services: {
        ...
        pushHint:
          "Ενεργοποίησε push σε αυτή τη συσκευή (π.χ. tablet manager). Χρειάζεται Chrome/Safari — όχι Messenger ή Instagram.",
        staffPushHint:
