  ...
  pages: {
    ...
    settings: {
      ...
      messagesTab: {
        ...
        hint:
          "Πρώτα φτιάχνεις πόστα στο tab «Πόστα» (π.χ. Κουζίνα, Bar).\nΜετά εδώ διαλέγεις πόστο και βάζεις τα μηνύματά του.\nServices = χάρτης σερβιτόρου (ξεχωριστά).",
        byPostTitle: "Μηνύματα ανά πόστο",
        byPostHint:
          "Διάλεξε πόστο από τη λίστα — έρχονται από το tab Πόστα. Πρόσθεσε ή σβήσε μηνύματα μόνο για αυτό το πόστο.",
        ...
        passPostHint: "Γρήγορα κουμπιά όταν στέλνει πάσο από tablet — μόνο για αυτό το πόστο.",
      ...
      personnel: {
        ...
        messagesPreviewTitle: "Μηνύματα που θα βλέπει",
        messagesPreviewWaiter: "Χάρτης θέσεων",
        messagesPreviewPass: "Γρήγορα κουμπιά πάσου",
