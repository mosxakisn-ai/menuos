...
export const DASHBOARD_EN = {
  ...
  onboarding: {
    ...
    guideIntro: "Complete 3 steps — then the full panel unlocks.",
    navLockedHint: "Complete the 3 getting-started steps first (Overview)",
    lockBanner: (step: number, label: string) =>
      `Step ${step}/3: ${label} — other pages stay locked until you finish.`,
    ...
    stepLabels: ["Open venue", "Build catalog", "Get QR codes"] as string[],
