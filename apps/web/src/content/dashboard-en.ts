  ...
  pages: {
    ...
    settings: {
      ...
      linksTab: {
        ...
        hint: "Copy or open the link on the tablet.\nFor a 2nd tablet at the same post (e.g. Beach): add a new screen with a label.",
      ...
      spacesTab: {
        ...
        hint: "Created automatically from spot names (e.g. Patio-1 → space «Patio»).\nRename how they appear on the waiter panel here.",
      ...
      personnel: {
        title: "Staff",
        description:
          "Each member gets a personal waiter link for their phone or tablet. Post assignments filter which pass alerts they see.",
        addTitle: "New member",
        addStaff: "Add",
        listTitle: "Team",
        editTitle: "Edit member",
        cancelEdit: "Cancel",
        stationsHint: "Which alerts they see on phone/tablet — Services = guest calls + all pass alerts.",
