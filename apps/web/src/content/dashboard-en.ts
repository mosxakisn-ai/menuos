...
export const DASHBOARD_EN = {
  ...
  pages: {
    ...
    history: {
      title: "History",
      description:
        "Completed pass deliveries — time from ready to delivered, filterable by space, post and staff.",
      daysLabel: "Period",
      days7: "7 days",
      days30: "30 days",
      days90: "90 days",
      filterDay: "Day",
      filterDayHint: "Empty = all days in the period · pick a date for that day only.",
      filterDayClear: "All days",
      filterSpot: "Space",
      filterPost: "Post",
      filterStaff: "Staff",
      filterAll: "All",
      ...
      showingCount: (count: number, limit: 50 | 100 | "all") =>
        limit === "all" ? `${count} records` : `Showing ${count} (up to ${limit})`,
      truncatedHint: "More exist — narrow filters or shorten the period",
      loading: "Loading...",
