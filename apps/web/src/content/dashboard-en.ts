...
export const DASHBOARD_EN = {
  ...
  pages: {
    ...
    qr: {
      ...
      bulkTitle: "Bulk add",
      bulkDesc:
        "Add as many tables, rooms or sunbeds as you need — no plan limit. Up to 200 spots at a time (repeat with a new range for more). Optional prefix for zones (e.g. sala-, kipos-).",
      ...
      spotPlaceholderTable: "12 or sala-1",
      addSpot: "Add",
      ...
      labelHint: "Letters, numbers, hyphen and underscore only (e.g. 12, sala-1).",
      previewSpot: "Preview",
      spotTypes: {
        TABLE: "Table",
        ROOM: "Room",
