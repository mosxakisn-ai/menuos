export const PAGES_EL = {
  ...
  services: {
    ...
    items: [
      ...
      },
      {
        title: "4 γλώσσες QR",
        description:
          "Στο QR menu ο πελάτης επιλέγει Ελληνικά, English, Deutsch ή Français — με ένα πάτημα.",
  ...
  howItWorks: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Συμπληρώνετε κείμενα στα Ελληνικά (υποχρεωτικά) και προαιρετικά EN / DE / FR. Ο επισκέπτης αλλάζει γλώσσα από το QR menu.",
  ...
  qrMenu: {
    ...
    benefits: [
      ...
      },
      {
        ...
        bullets: ["GR / EN / DE / FR", "Καλύτερη εμπειρία", "4 γλώσσες QR"],
      },
      {
        title: "Visual menu",
  ...
  about: {
    ...
    paragraphs: [
      ...
      "Γνωρίζουμε την ελληνική αγορά φιλοξενίας: εποχικότητα, τουρίστες, 4 γλώσσες QR, γρήγορες αλλαγές τιμών.",
