  ...
  services: {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Έχετε έτοιμο έντυπο menu; Το ανεβάζετε — κατηγορίες, πιάτα και τιμές γεμίζουν σχεδόν μόνα τους. Για σκαν ή δύσκολο layout μπαίνει Gemini AI. Εσείς ελέγχετε πριν δημοσιευτεί.",
        bullets: ["Λιγότερη πληκτρολόγηση", "OCR + Gemini AI για σκαν", "Έλεγχος πριν live"],
        href: "/pricing",
      },
      {
      ...
      },
      {
        ...
        description:
          "Live ειδοποιήσεις για σερβιτόρους, κουζίνα και μπαρ — συνδεδεμένες με το ίδιο QR menu. Χωρίς POS.",
        bullets: ["Push στο κινητό", "Έτοιμο πιάτο & ποτό", "Link χωρίς login"],
      },
      {
